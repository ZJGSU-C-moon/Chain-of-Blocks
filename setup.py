...
sql = "CREATE TABLE UTXO(id INT PRIMARY KEY AUTO_INCREMENT,UTXO TEXT(500), TXS_HASH TEXT(1000), INDEX CHAR(10) ,OWNER TEXT(800), VALUE CHAR(10),IF_USE CHAR(1));"
cursor.execute(sql)
db.commit()
...
sql = "CREATE TABLE BLOCK(id INT PRIMARY KEY AUTO_INCREMENT,BLOCK_HEX TEXT(1000),BLOCK_HEADER_HASH TEXT(1000));"
cursor.execute(sql)
db.commit()
